...
Current executable location: the six short protected structural scenarios live in
`tests/test_golden_replay_structural_invariants.py` and are enumerated by
`tests/helpers/protected_replay_registry.py`. Current helper/projection location:
...
scenarios are acceptance-blocking versus supporting/diagnostic.
