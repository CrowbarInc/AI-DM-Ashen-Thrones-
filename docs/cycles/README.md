...
| Cycle AF governance recon | `docs/audits/discovery/cycle_af_dead_governance_removal_recon_2026-05-31.md` |
...
| **AF** | Dead governance removal | [`docs/audits/discovery/cycle_af_dead_governance_removal_recon_2026-05-31.md`](../cycle_af_dead_governance_removal_recon_2026-05-31.md) (repo `docs/`, not this folder) | `cycle_af_dead_governance_removal_closure_2026-05-31.md` |
...
- `docs/audits/closeouts/evaluator_convergence_closeout.md`, `docs/gate_convergence_closeout.md`, `docs/final_emission_ownership_convergence.md` — maintenance-grade closeouts enforced in CI
