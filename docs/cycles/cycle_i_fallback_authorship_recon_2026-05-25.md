...
- `docs/cycles/cycle_h_runtime_lineage_closure_2026-05-25.md` - current lineage contract and gate-owned opening recurrence example.
- `docs/cycles/cycle_h_runtime_lineage_instrumentation_recon_2026-05-23.md` - pre-implementation attribution rationale.
