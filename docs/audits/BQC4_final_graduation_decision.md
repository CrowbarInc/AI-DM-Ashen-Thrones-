...
- BQ-C4 calibration score: `55.3`
- Score delta: `-2.0`
- BQ-C3 largest gap: `0.61`
- BQ-C4 largest gap: `0.80`
- Gap delta: `+0.19`
...
- calibration score below target (55.3 < 70)
- largest calibration gap above target (0.80 > 0.20)
