"""CA10 corrective prevention effectiveness report generator."""
...
from tests.helpers.corrective_prevention_effectiveness import (  # noqa: E402
    DEFAULT_BASELINE_JSON_PATH,
    DEFAULT_CA7_JSON_PATH,
    DEFAULT_CA8_JSON_PATH,
    DEFAULT_CA9_JSON_PATH,
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Generate CA10 corrective prevention effectiveness report.",
    )
    ...
    parser.add_argument("--ca9-json", type=Path, default=ROOT / DEFAULT_CA9_JSON_PATH)
