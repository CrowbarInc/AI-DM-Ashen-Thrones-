"""CA7 corrective fix absence report generator."""
...
from tests.helpers.corrective_fix_absence_report import (  # noqa: E402
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Generate CA7 corrective fix absence validation report.",
    )
    parser.add_argument(
        "--exclusions-csv",
        type=Path,
        default=ROOT / DEFAULT_EXCLUSIONS_CSV_PATH,
    )
    parser.add_argument(
        "--review-queue-csv",
        type=Path,
    ...
    parser.add_argument(
        "--ca6-report",
        type=Path,
        default=ROOT / DEFAULT_CA6_REPORT_PATH,
    )
    parser.add_argument(
        "--output-md",
        type=Path,
    ...
    _report, markdown = write_corrective_fix_absence_report(
        ...
        ca6_report_path=args.ca6_report,
        repo_root=ROOT,
    )
