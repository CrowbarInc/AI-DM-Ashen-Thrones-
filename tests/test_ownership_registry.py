...
def test_bj52_fallback_provenance_gate_wrappers_collapsed() -> None:
    """Cycle BJ-52: upstream fallback provenance containment wrappers removed from gate."""
...
def test_bj125_ownership_registry_anti_reset_tests_patch_strict_social_owner_not_gate() -> None:
    """Cycle BJ-125: anti-reset tests patch social_exchange_emission, not removed gate re-export."""
    import inspect
    import pathlib
    ...
    assert 'monkeypatch.setattr(gate_context, "strict_social_emission_will_apply"' in module_src
    ...
    assert "import game.final_emission_gate_context as gate_context" in text
...
def test_bj126_ownership_registry_narration_transcript_tests_patch_strict_social_owner_not_gate() -> None:
    """Cycle BJ-126: narration transcript tests patch owner/gate_context, not removed gate re-export."""
    import inspect
    import pathlib
    ...
    assert 'monkeypatch.setattr(gate_context, "strict_social_emission_will_apply"' in helper_src
