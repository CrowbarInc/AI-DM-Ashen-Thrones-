...
from game.final_emission_meta_read import (
    ...
    PRODUCER_REPAIR_KIND_PASSIVE_SCENE_PRESSURE_FALLBACK,
...
_PRODUCER_REPAIR_KIND_FIELD_CONSTANT: str = "PRODUCER_REPAIR_KIND_FIELD"

# Classifier-aligned producer repair kinds (parity with ``ALLOWED_PRODUCER_REPAIR_KINDS``).
_PRODUCER_REPAIR_KIND_CLASSIFIER_CONSTANTS: tuple[str, ...] = (
    "PRODUCER_REPAIR_KIND_VISIBILITY_ENFORCEMENT",
    "PRODUCER_REPAIR_KIND_FIRST_MENTION_ENFORCEMENT",
    "PRODUCER_REPAIR_KIND_REFERENTIAL_CLARITY_ENFORCEMENT",
    "PRODUCER_REPAIR_KIND_REFERENTIAL_CLARITY_LOCAL_SUBSTITUTION",
...
def observability_attribution_read_surface() -> dict[str, object]:
    ...
    return {
        ...
        "producer_repair_kind_field_constant": _PRODUCER_REPAIR_KIND_FIELD_CONSTANT,
        "producer_repair_kind_constants": list(_PRODUCER_REPAIR_KIND_CLASSIFIER_CONSTANTS),
