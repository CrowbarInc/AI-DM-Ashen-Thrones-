...
from game.config import DEFAULT_MODEL_NAME, get_openai_api_key
...
def run_upstream_api_preflight(
    *,
    ...
    Requires an explicit ``api_key`` or a configured ``OPENAI_API_KEY`` unless
    caller-level preflight skip logic has already bypassed this function.
    """
