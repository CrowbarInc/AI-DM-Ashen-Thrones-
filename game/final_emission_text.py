...
Legacy semantic sentence-repair helpers (``_decompress_overpacked_sentences``,
``_repair_fragmentary_participial_splits``) remain here for unit tests only. They are
**not** invoked at the C2 packaging-only final-emission boundary.
"""
