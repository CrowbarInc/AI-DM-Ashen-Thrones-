...
- **Command:** `python tools/ck_hotspot_compression_report.py --measurement-commit 1f3899b --cycle-label 'CJ3 repeat B' --output-md 'artifacts\ck1_repeat_b.md' --output-json 'artifacts\ck1_repeat_b.json'`
...
|---|---|---|---:|---:|---|---:|---|
| CJ3 repeat B | `1f3899b` | 2026-06-26 | 100.0 | 100.0 | tests/helpers/ck_hotspot_compression_report.py (50.0%) | 0 | `std=v1; REV_RANGE=85855df..1f3899b; total_touches=4; FI top5=20.79% top10=32.76% above_T10=39; cycle=CJ3 repeat B` |
