...
```json
{
  ...
  "mandatory_gate_failure_counts": {
    "player_intent_addressed": 1
  },
  "diagnostic_only_warnings": 0,
  "failure_classification_counts": {
    "A_KNOWN_EVALUATOR_DETECTED_FAILURE": 1
  },
  "failure_clusters": {
  ...
  "campaign_id": "20260918T022209Z",
  "run_artifact_paths": [
    "C:\\Users\\Master Mandalcio\\Documents\\Tabletop Gaming\\AI Dungeon Master\\ashen_thrones_ai_gm\\artifacts\\reactive_adversarial_players\\20260918T022209Z\\patrol_knowledge_adversarial_seed1701\\run.json"
  ]
}
```
